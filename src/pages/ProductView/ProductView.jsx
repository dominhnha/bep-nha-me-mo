...
import { formatNumber, formatTimestamptoDate } from '../../utils/Format'
          ...
          </SectionTitle>
          {
            product != null
              ? <ul className="ProductView__expiryday">
                <span className="ProductView__expiryday__title"> Hạn sử dụng</span>
                <li>
                  <span className="ProductView__desc"> từ ngày</span>
                  <input
                    id="First"
                    name="First"
                    type="date"
                    className='ProductView__date'
                    value={product.Info.exp ? formatTimestamptoDate(product.Info.exp.toDate()) : "0-0-0"}
                    disabled={true}
                  /> 
                </li>
                <li>
                  <span className="ProductView__desc"> Đến ngày</span>
                  <input
                    id="last"
                    name="last"
                    type="date"
                    className='ProductView__date'
                    value={product.Info.mfg ? formatTimestamptoDate(product.Info.mfg.toDate()) : "0-0-0"}
                    disabled={true}
                  /> 
